...
/**
 * Get default organization schema for Invoicing app
 */
export function getInvoicingOrganizationSchema(): OrganizationSchema {
  return {
    name: 'Invoicing Platform',
    url: import.meta.env.VITE_PUBLIC_SITE_URL || 'https://invoicing.your-domain.com',
    description: 'Comprehensive invoice and billing management SaaS platform for businesses.',
  }
}
