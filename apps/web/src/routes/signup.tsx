      ...
      if (result.error) {
        ...
        try {
          ...
          if (orgResult.data) {
            ...
            // Persist slug for oRPC client header
            localStorage.setItem("organization_slug", orgSlug);
          }
        } catch (orgError) {
          console.warn("Failed to auto-create organization:", orgError);
          // Non-fatal — user can create org later
        }
